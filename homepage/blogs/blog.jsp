...
<html>
	<head>
		<title>my blog</title>
		<link href="/mWebsite/blogs/blog.css" rel="stylesheet">
			...
			<header>
				...
				<nav class="tags">
					<dl>
						...
						<dt style="background-color: #750F19"><a href="">Blog</a></dt>
...
<!-- comments container -->
			<div id="comments_div">
				<form action="../contactService" method="post" class="basic-grey">
					...
					<fieldset>
						...
						<colgroup span = "2">
							...
							<tr>
								...
								placeholder = "article title here"> </td>
							</tr>	
							<tr>
								<td>Tag</td>
								<td><input type = "text" id = "blog_tag" name = "tag" 
								placeholder = "article tag (category)"> </td>
							</tr>
						</table>	
